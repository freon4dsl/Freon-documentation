...
import { Box, BoxUtil, FreBoxProvider, FreProjectionHandler, NumberDisplay, BoxFactory, createDefaultExpressionBox } from "@freon4dsl/core";

import { PercentageLiteral } from "../../language/gen/index.js";

/**
 * This class implements the box provider for a single node of type PercentageLiteral.
 ...
 */
export class PercentageLiteralBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return createDefaultExpressionBox(
            this._node as PercentageLiteral,
            [
                BoxFactory.horizontalLayout(
                    ...
                    "",
                    [
                        BoxUtil.numberBox(this._node as PercentageLiteral, "value", NumberDisplay.SELECT),
                        BoxUtil.labelBox(this._node as PercentageLiteral, "%", "top-1-line-0-item-1"),
                    ],
                    { selectable: false },
                ),
            ],
