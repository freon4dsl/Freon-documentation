...
import { FunctionCallExpression, CalcFunction } from "../../language/gen/index.js";
                ...
                BoxFactory.horizontalLayout(
                    ...
                    [
                        BoxUtil.referenceBox(
                            ...
                            "funcDefinition",
                            (selected: string) => {
                                (this._node as FunctionCallExpression).funcDefinition = FreNodeReference.create<CalcFunction>(
                                    selected,
                                    "CalcFunction",
                                );
                            },
                        ...
                        BoxUtil.horizontalPartListBox(
                            this._node as FunctionCallExpression,
                            (this._node as FunctionCallExpression).args,
                            "args",
                            { text: ",", type: "Separator" },
                            this.mainHandler,
                        ),
                        BoxUtil.labelBox(this._node as FunctionCallExpression, ")", "top-1-line-0-item-3"),
                    ],
                    { selectable: false },
                ),
            ],
