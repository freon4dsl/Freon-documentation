...
/**
 * This class implements the box provider for a single node of type NumberLiteral.
 ...
 */
export class NumberLiteralBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return createDefaultExpressionBox(
            this._node as NumberLiteral,
            [BoxUtil.numberBox(this._node as NumberLiteral, "value", NumberDisplay.SELECT)],
            { selectable: false },
        );
    }
}
