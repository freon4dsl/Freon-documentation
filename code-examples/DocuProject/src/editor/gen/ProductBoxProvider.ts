...
import { Product } from "../../language/gen/index.js";

/**
 * This class implements the box provider for a single node of type Product.
 ...
 */
export class ProductBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxUtil.getBoxOrAction(this._node as Product, "product", "InsuranceProduct", this.mainHandler);
    }

    private getComments(): Box {
        return BoxFactory.verticalLayout(this._node as Product, "Product-overall", "", [
            BoxUtil.labelBox(this._node as Product, "/* This is a model unit that contains an insurance product */", "top-1-line-0-item-0"),
            BoxUtil.getBoxOrAction(this._node as Product, "product", "InsuranceProduct", this.mainHandler),
        ]);
    }
}
