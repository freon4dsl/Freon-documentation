...
/**
 * Class BooleanType is the implementation of the limited concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to any changes in the state of its properties.
 */
export class BooleanType extends MobxModelElementImpl implements FreNamedNode, NamedType {
    /**
     * A convenience method that creates an instance of this class
     * based on the properties defined in 'data'.
     * @param data partial object
     */
    static create(data: Partial<BooleanType>): BooleanType {
    ...
    static Boolean: BooleanType; // implementation of instance Boolean
    static $freANY: BooleanType; // default predefined instance

    readonly $typename: string = "BooleanType"; // holds the metatype in the form of a string
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<BooleanType>): boolean {
