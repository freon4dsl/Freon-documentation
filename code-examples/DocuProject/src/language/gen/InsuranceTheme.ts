...
/**
 * Class InsuranceTheme is the implementation of the limited concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to any changes in the state of its properties.
 */
export class InsuranceTheme extends MobxModelElementImpl implements FreNamedNode {
    /**
     * A convenience method that creates an instance of this class
     * based on the properties defined in 'data'.
     * @param data partial object
     */
    static create(data: Partial<InsuranceTheme>): InsuranceTheme {
    ...
    static HomeTheme: InsuranceTheme; // implementation of instance HomeTheme
    static HealthTheme: InsuranceTheme; // implementation of instance HealthTheme
    static LegalTheme: InsuranceTheme; // implementation of instance LegalTheme
    static $freANY: InsuranceTheme; // default predefined instance

    readonly $typename: string = "InsuranceTheme"; // holds the metatype in the form of a string
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<InsuranceTheme>): boolean {
