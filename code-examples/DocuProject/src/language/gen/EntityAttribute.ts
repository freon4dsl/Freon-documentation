...
/**
 * Class EntityAttribute is the implementation of the concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to the changes in the state of its properties.
 */
export class EntityAttribute extends MobxModelElementImpl implements FreNode {
    /**
     * A convenience method that creates an instance of this class
     * based on the properties defined in 'data'.
     * @param data partial object
     */
    static create(data: Partial<EntityAttribute>): EntityAttribute {
    ...
    readonly $typename: string = "EntityAttribute"; // holds the metatype in the form of a string
    $id: string = ""; // a unique identifier
    parseLocation: FreParseLocation; // if relevant, the location of this element within the source from which it is parsed
    numVal: number; // implementation of numVal
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<EntityAttribute>): boolean {
