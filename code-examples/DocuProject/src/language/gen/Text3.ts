...
/**
 * Class Text3 is the implementation of the concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to the changes in the state of its properties.
 */
export class Text3 extends MobxModelElementImpl implements FreNode {
    /**
    ...
    readonly $typename: string = "Text3"; // holds the metatype in the form of a string
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<Text3>): boolean {
