...
/**
 * Class EuroType is the implementation of the limited concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to any changes in the state of its properties.
 */
export class EuroType extends MobxModelElementImpl implements FreNamedNode, NamedType {
    /**
     * A convenience method that creates an instance of this class
     * based on the properties defined in 'data'.
     * @param data partial object
     */
    static create(data: Partial<EuroType>): EuroType {
    ...
    static EUR: EuroType; // implementation of instance EUR
    static $freANY: EuroType; // default predefined instance

    readonly $typename: string = "EuroType"; // holds the metatype in the form of a string
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<EuroType>): boolean {
