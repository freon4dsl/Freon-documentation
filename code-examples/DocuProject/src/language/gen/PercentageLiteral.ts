...
/**
 * Class PercentageLiteral is the implementation of the concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to the changes in the state of its properties.
 */
export class PercentageLiteral extends Literal implements FreExpressionNode {
    /**
     * A convenience method that creates an instance of this class
     * based on the properties defined in 'data'.
     * @param data partial object
     */
    static create(data: Partial<PercentageLiteral>): PercentageLiteral {
    ...
    readonly $typename: string = "PercentageLiteral"; // holds the metatype in the form of a string
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<PercentageLiteral>): boolean {
