...
export class AttributeWithEntityType extends MobxModelElementImpl {
	static create(data) {
		const result = new AttributeWithEntityType(data.$id);
		if (!!data.name) {
	...
	constructor(id) {
		super();
		this.$typename = 'AttributeWithEntityType';
		this.$id = '';
		if (!!id) {
			this.$id = id;
		} else {
...
//# sourceMappingURL=AttributeWithEntityType.js.map
