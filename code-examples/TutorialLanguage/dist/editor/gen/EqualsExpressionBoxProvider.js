...
export class EqualsExpressionBoxProvider extends FreBoxProvider {
	...
	getDefault() {
		return createDefaultBinaryBox(this._node, 'EqualsExpression', EntityModelEnvironment.getInstance().editor, this.mainHandler);
	}
	getBrackets() {
...
//# sourceMappingURL=EqualsExpressionBoxProvider.js.map
