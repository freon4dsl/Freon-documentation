...
export class AndExpressionBoxProvider extends FreBoxProvider {
	constructor(mainHandler) {
		super(mainHandler);
		this.knownBoxProjections = ['default'];
		this.knownTableProjections = ['default'];
		this.conceptName = 'AndExpression';
	}
	...
	getDefault() {
		return createDefaultBinaryBox(this._node, 'AndExpression', EntityModelEnvironment.getInstance().editor, this.mainHandler);
	}
	getBrackets() {
...
//# sourceMappingURL=AndExpressionBoxProvider.js.map
