...
export class StringLiteralExpressionBoxProvider extends FreBoxProvider {
			...
			[
				BoxFactory.horizontalLayout(
					...
					[
						...
						BoxUtil.textBox(this._node, 'value'),
	...
	getDefault() {
		return createDefaultExpressionBox(
			...
			'default-expression-box',
			[
				BoxFactory.verticalLayout(this._node, 'StringLiteralExpression-overall', '', [
					BoxFactory.horizontalLayout(
						this._node,
						'StringLiteralExpression-hlist-line-0',
						'',
						[
							BoxUtil.labelBox(this._node, 'StringLiteralExpression', 'top-1-line-0-item-0'),
...
//# sourceMappingURL=StringLiteralExpressionBoxProvider.js.map
