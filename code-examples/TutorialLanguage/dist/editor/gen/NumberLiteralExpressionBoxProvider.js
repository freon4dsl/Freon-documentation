...
export class NumberLiteralExpressionBoxProvider extends FreBoxProvider {
	constructor(mainHandler) {
		super(mainHandler);
		this.knownBoxProjections = ['StartEditor', 'default'];
		this.knownTableProjections = ['default'];
		this.conceptName = 'NumberLiteralExpression';
	}
	...
	getStartEditor() {
		return createDefaultExpressionBox(this._node, 'default-expression-box', [BoxUtil.textBox(this._node, 'value')], { selectable: false });
	}
	getDefault() {
		return createDefaultExpressionBox(
			...
			[
				BoxFactory.verticalLayout(this._node, 'NumberLiteralExpression-overall', '', [
					BoxFactory.horizontalLayout(
						this._node,
						'NumberLiteralExpression-hlist-line-0',
						'',
						[
							BoxUtil.labelBox(this._node, 'NumberLiteralExpression', 'top-1-line-0-item-0'),
					...
					BoxUtil.indentBox(
						...
						BoxFactory.horizontalLayout(
							this._node,
							'NumberLiteralExpression-hlist-line-1',
							'',
					...
					BoxFactory.optional2(
						...
						BoxUtil.indentBox(
							...
							BoxFactory.horizontalLayout(
								this._node,
								'NumberLiteralExpression-optional-appliedfeature-hlist-line-0',
								'',
								[
...
//# sourceMappingURL=NumberLiteralExpressionBoxProvider.js.map
