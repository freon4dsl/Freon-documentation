...
export class VariableRefBoxProvider extends FreBoxProvider {
	...
	getDefault() {
		return createDefaultExpressionBox(
			...
			[
				BoxFactory.verticalLayout(this._node, 'VariableRef-overall', '', [
					BoxFactory.horizontalLayout(
						this._node,
						'VariableRef-hlist-line-0',
						'',
						[BoxUtil.labelBox(this._node, 'VariableRef', 'top-1-line-0-item-0'), BoxUtil.labelBox(this._node, '{', 'top-1-line-0-item-1')],
						{ selectable: false }
					),
					...
					BoxUtil.indentBox(
						...
						BoxFactory.horizontalLayout(
							...
							'',
							[
								BoxUtil.labelBox(this._node, 'variable', 'top-1-line-2-item-0'),
								BoxUtil.referenceBox(
									this._node,
									'variable',
									(selected) => {
										this._node.variable = FreNodeReference.create(selected, 'Variable');
									},
...
//# sourceMappingURL=VariableRefBoxProvider.js.map
