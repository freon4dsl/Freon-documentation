...
export class LessThenExpressionBoxProvider extends FreBoxProvider {
	constructor(mainHandler) {
		super(mainHandler);
		this.knownBoxProjections = ['default'];
		this.knownTableProjections = ['default'];
		this.conceptName = 'LessThenExpression';
	}
...
//# sourceMappingURL=LessThenExpressionBoxProvider.js.map
