...
export class GreaterThenExpressionBoxProvider extends FreBoxProvider {
	...
	getDefault() {
		return createDefaultBinaryBox(this._node, 'GreaterThenExpression', EntityModelEnvironment.getInstance().editor, this.mainHandler);
	}
	getBrackets() {
...
//# sourceMappingURL=GreaterThenExpressionBoxProvider.js.map
