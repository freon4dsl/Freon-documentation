 ...
 */
export class MockEnumeration extends MobxModelElementImpl implements FreNamedNode {
    /**
    ...
    static $freANY: MockEnumeration; // default predefined instance

    readonly $typename: string = "MockEnumeration"; // holds the metatype in the form of a string
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<MockEnumeration>): boolean {
