 ...
 */
export class EqualsExpression extends ComparisonExpression implements FreBinaryExpression {
    /**
    ...
    readonly $typename: string = "EqualsExpression"; // holds the metatype in the form of a string
