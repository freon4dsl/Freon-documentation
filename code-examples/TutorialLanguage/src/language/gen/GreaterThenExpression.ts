...
import { ComparisonExpression, EntityExpression } from "./internal.js";
 ...
 */
export class GreaterThenExpression extends ComparisonExpression implements FreBinaryExpression {
    /**
    ...
    readonly $typename: string = "GreaterThenExpression"; // holds the metatype in the form of a string
