 ...
 */
export class BooleanLiteralExpression extends LiteralExpression implements FreExpressionNode {
    /**
    ...
    readonly $typename: string = "BooleanLiteralExpression"; // holds the metatype in the form of a string
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<BooleanLiteralExpression>): boolean {
