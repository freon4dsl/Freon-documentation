 ...
 */
export class AttributeWithEntityType extends MobxModelElementImpl implements FreNamedNode {
    /**
    ...
    readonly $typename: string = "AttributeWithEntityType"; // holds the metatype in the form of a string
    ...
    declaredType: FreNodeReference<Entity>; // implementation of reference 'declaredType'
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<AttributeWithEntityType>): boolean {
