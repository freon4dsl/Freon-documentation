 ...
 */
export class Variable extends MobxModelElementImpl implements FreNamedNode {
    /**
    ...
    readonly $typename: string = "Variable"; // holds the metatype in the form of a string
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<Variable>): boolean {
