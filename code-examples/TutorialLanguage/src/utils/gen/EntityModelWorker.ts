...
/**
 * Interface EntityModelWorker implements the extended visitor pattern of instances of language EntityModel.
 * Class EntityModelWalker implements the traversal of the model tree, classes that implement this interface
