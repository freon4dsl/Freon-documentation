...
import { AbsExpression } from "../../language/gen/index.js";

/**
 * This class implements the box provider for a single node of type AbsExpression.
...
export class AbsExpressionBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return createDefaultExpressionBox(
            this._node as AbsExpression,
            [
                BoxFactory.verticalLayout(this._node as AbsExpression, "AbsExpression-overall", "", [
                    BoxFactory.horizontalLayout(
                        this._node as AbsExpression,
                        "AbsExpression-hlist-line-0",
                        "",
                        [
                            BoxUtil.labelBox(this._node as AbsExpression, "AbsExpression", "top-1-line-0-item-0"),
                            BoxUtil.labelBox(this._node as AbsExpression, "{", "top-1-line-0-item-1"),
                        ],
                        { selectable: false },
                    ),
                    BoxUtil.indentBox(
                        ...
                        BoxFactory.horizontalLayout(
                            ...
                            "",
                            [
                                BoxUtil.labelBox(this._node as AbsExpression, "expr", "top-1-line-1-item-0"),
                                BoxUtil.getBoxOrAction(this._node as AbsExpression, "expr", "EntityExpression", this.mainHandler),
                            ],
                            { selectable: false },
                        ),
                    ),
                    BoxFactory.optional2(
                        ...
                        () => !!(this._node as AbsExpression).appliedfeature,
                        BoxUtil.indentBox(
                            this._node as AbsExpression,
                            4,
                            "0",
                            BoxFactory.horizontalLayout(
                                ...
                                "",
                                [
                                    BoxUtil.labelBox(this._node as AbsExpression, "appliedfeature", "top-2-line-0-item-0"),
                    ...
                    BoxUtil.labelBox(this._node as AbsExpression, "}", "top-1-line-3-item-0"),
                ]),
            ],
            { selectable: false },
        );
