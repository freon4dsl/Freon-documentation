...
import { SomeOtherModelUnit } from "../../language/gen/index.js";

/**
 * This class implements the box provider for a single node of type SomeOtherModelUnit.
...
export class SomeOtherModelUnitBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(this._node as SomeOtherModelUnit, "SomeOtherModelUnit-overall", "", [
            BoxFactory.horizontalLayout(
                this._node as SomeOtherModelUnit,
                "SomeOtherModelUnit-hlist-line-0",
                "",
                [
                    BoxUtil.labelBox(this._node as SomeOtherModelUnit, "SomeOtherModelUnit", "top-1-line-0-item-0"),
                    BoxUtil.textBox(this._node as SomeOtherModelUnit, "name"),
                    BoxUtil.labelBox(this._node as SomeOtherModelUnit, "{", "top-1-line-0-item-2"),
                ],
                { selectable: false },
            ),
            BoxUtil.indentBox(
                ...
                BoxFactory.horizontalLayout(
                    ...
                    "",
                    [
                        BoxUtil.labelBox(this._node as SomeOtherModelUnit, "somePart", "top-1-line-1-item-0"),
                        BoxUtil.getBoxOrAction(this._node as SomeOtherModelUnit, "somePart", "Entity", this.mainHandler),
                    ],
                    { selectable: false },
                ),
            ),
            BoxUtil.labelBox(this._node as SomeOtherModelUnit, "}", "top-1-line-2-item-0"),
        ]);
    }
}
