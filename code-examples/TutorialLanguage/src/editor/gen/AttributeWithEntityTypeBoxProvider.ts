...
import { AttributeWithEntityType, Entity } from "../../language/gen/index.js";

import { EntityModelEnvironment } from "../../config/gen/EntityModelEnvironment.js";

/**
 * This class implements the box provider for a single node of type AttributeWithEntityType.
...
export class AttributeWithEntityTypeBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(this._node as AttributeWithEntityType, "AttributeWithEntityType-overall", "", [
            BoxFactory.horizontalLayout(
                this._node as AttributeWithEntityType,
                "AttributeWithEntityType-hlist-line-0",
                "",
                [
                    BoxUtil.labelBox(this._node as AttributeWithEntityType, "AttributeWithEntityType", "top-1-line-0-item-0"),
                    BoxUtil.textBox(this._node as AttributeWithEntityType, "name"),
                    BoxUtil.labelBox(this._node as AttributeWithEntityType, "{", "top-1-line-0-item-2"),
                ],
                { selectable: false },
            ),
            BoxUtil.indentBox(
                ...
                BoxFactory.horizontalLayout(
                    ...
                    "",
                    [
                        BoxUtil.labelBox(this._node as AttributeWithEntityType, "declaredType", "top-1-line-1-item-0"),
                        BoxUtil.referenceBox(
                            this._node as AttributeWithEntityType,
                            "declaredType",
                            (selected: string) => {
                                (this._node as AttributeWithEntityType).declaredType = FreNodeReference.create<Entity>(selected, "Entity");
                            },
            ...
            BoxUtil.labelBox(this._node as AttributeWithEntityType, "}", "top-1-line-2-item-0"),
        ]);
    }
}
