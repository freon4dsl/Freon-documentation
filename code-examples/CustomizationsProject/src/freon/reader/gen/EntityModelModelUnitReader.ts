...
import { EntityModel } from "../../language/gen/index.js";
import { EntityModelGrammarStr } from "./EntityModelGrammar.js";
import { EntityModelSyntaxAnalyser } from "./EntityModelSyntaxAnalyser.js";
import { EntityModelSemanticAnalyser } from "./EntityModelSemanticAnalyser.js";

/**
 *   Class EntityModelModelUnitReader is a wrapper for the various parsers of
 *   modelunits.
 */
export class EntityModelModelUnitReader implements FreReader {
    analyser: EntityModelSyntaxAnalyser = new EntityModelSyntaxAnalyser();
    parser: LanguageProcessor = Agl.processorFromString(EntityModelGrammarStr, this.analyser, null, null);
