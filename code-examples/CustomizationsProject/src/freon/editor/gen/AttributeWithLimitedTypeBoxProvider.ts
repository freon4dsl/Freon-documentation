...
import { AttributeWithLimitedType, AttributeType } from "../../language/gen/index.js";

import { EntityModelEnvironment } from "../../config/gen/EntityModelEnvironment.js";

/**
 * This class implements the box provider for a single node of type AttributeWithLimitedType.
...
export class AttributeWithLimitedTypeBoxProvider extends FreBoxProvider {
    ...
    private getStartEditor(): Box {
        return BoxFactory.horizontalLayout(
            this._node as AttributeWithLimitedType,
            "AttributeWithLimitedType-hlist-line-0",
            "",
            [
                BoxUtil.textBox(this._node as AttributeWithLimitedType, "name"),
                BoxUtil.labelBox(this._node as AttributeWithLimitedType, ":", "top-1-line-0-item-1"),
                BoxUtil.limitedBox(
                    this._node as AttributeWithLimitedType,
                    "declaredType",
                    (selected: string) => {
                        (this._node as AttributeWithLimitedType).declaredType = FreNodeReference.create<AttributeType>(
                            selected,
                            "AttributeType",
                        );
                    },
    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(this._node as AttributeWithLimitedType, "AttributeWithLimitedType-overall", "", [
            BoxFactory.horizontalLayout(
                this._node as AttributeWithLimitedType,
                "AttributeWithLimitedType-hlist-line-0",
                "",
                [
                    BoxUtil.labelBox(this._node as AttributeWithLimitedType, "AttributeWithLimitedType", "top-1-line-0-item-0"),
                    BoxUtil.textBox(this._node as AttributeWithLimitedType, "name"),
                    BoxUtil.labelBox(this._node as AttributeWithLimitedType, "\{", "top-1-line-0-item-2"),
                ],
                { selectable: false },
            ),
            BoxUtil.indentBox(
                ...
                BoxFactory.horizontalLayout(
                    ...
                    "",
                    [
                        BoxUtil.labelBox(this._node as AttributeWithLimitedType, "declaredType", "top-1-line-1-item-0"),
                        BoxUtil.limitedBox(
                            this._node as AttributeWithLimitedType,
                            "declaredType",
                            (selected: string) => {
            ...
            BoxUtil.labelBox(this._node as AttributeWithLimitedType, "}", "top-1-line-2-item-0"),
        ]);
    }
}
