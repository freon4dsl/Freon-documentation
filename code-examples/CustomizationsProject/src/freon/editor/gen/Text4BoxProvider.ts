...
import { Text4 } from "../../language/gen/index.js";

/**
 * This class implements the box provider for a single node of type Text4.
...
export class Text4BoxProvider extends FreBoxProvider {
    ...
    private getStartEditor(): Box {
        return BoxFactory.verticalLayout(this._node as Text4, "Text4-overall", "", [
            BoxUtil.indentBox(this._node as Text4, 10, "0", BoxUtil.labelBox(this._node as Text4, "This is", "top-1-line-0-item-0")),
            BoxUtil.indentBox(this._node as Text4, 8, "1", BoxUtil.labelBox(this._node as Text4, "literal text", "top-1-line-1-item-0")),
            BoxUtil.indentBox(
                this._node as Text4,
                3,
                "2",
                BoxUtil.labelBox(this._node as Text4, "that is projected in the", "top-1-line-2-item-0"),
            ),
            BoxUtil.indentBox(this._node as Text4, 11, "3", BoxUtil.labelBox(this._node as Text4, "editor", "top-1-line-3-item-0")),
            BoxUtil.labelBox(this._node as Text4, "for every concept of type Text.", "top-1-line-4-item-0"),
        ]);
    }
    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(this._node as Text4, "Text4-overall", "", [
            BoxFactory.horizontalLayout(
                ...
                "",
                [
                    BoxUtil.labelBox(this._node as Text4, "Text4", "top-1-line-0-item-0"),
                    BoxUtil.labelBox(this._node as Text4, "\{", "top-1-line-0-item-1"),
                ],
                { selectable: false },
            ),
            BoxUtil.labelBox(this._node as Text4, "}", "top-1-line-1-item-0"),
        ]);
    }
}
