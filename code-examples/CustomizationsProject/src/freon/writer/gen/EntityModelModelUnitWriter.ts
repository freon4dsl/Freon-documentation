...
/**
 * Class EntityModelModelUnitWriter provides methods to return a string representation of an instance of
 * elements of language EntityModel.
 * It is, amongst others, used to create error messages in the validator.
 */
export class EntityModelModelUnitWriter implements FreWriter {
     ...
     */
    private unparseBaseType(modelelement: FreNode, short: boolean) {
