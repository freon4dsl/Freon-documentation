 ...
 */
export class AndExpression extends BinaryExpression implements FreBinaryExpression {
    /**
    ...
    readonly $typename: string = "AndExpression"; // holds the metatype in the form of a string
