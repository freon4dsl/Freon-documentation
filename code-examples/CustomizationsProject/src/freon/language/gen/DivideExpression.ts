 ...
 */
export class DivideExpression extends BinaryExpression implements FreBinaryExpression {
    /**
    ...
    readonly $typename: string = "DivideExpression"; // holds the metatype in the form of a string
