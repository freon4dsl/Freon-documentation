 ...
 */
export class LessThenExpression extends ComparisonExpression implements FreBinaryExpression {
    /**
    ...
    readonly $typename: string = "LessThenExpression"; // holds the metatype in the form of a string
