...
import { EntityFunction, Entity } from "./internal.js";
 ...
 */
export class EntityModelUnit extends MobxModelElementImpl implements FreModelUnit {
    /**
    ...
    readonly $typename: string = "EntityModelUnit"; // holds the metatype in the form of a string
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<EntityModelUnit>): boolean {
