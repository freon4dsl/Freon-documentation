...
import { EntityModelInterpreter } from "../EntityModelInterpreter.js";

/**
 * The class that registers all interpreter function with the main interpreter.
 */
export function EntityModelInterpreterInit(main: IMainInterpreter) {
    ...
    main.registerFunction("EntityModelUnit", interpreter.evalEntityModelUnit); // DONE
}
