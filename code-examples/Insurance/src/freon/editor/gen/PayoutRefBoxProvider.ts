...
import { PayoutRef } from "../../language/gen/index.js";

/**
 * This class implements the box provider for a single node of type PayoutRef.
 ...
 */
export class PayoutRefBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxUtil.labelBox(this._node as PayoutRef, "maximumPayOut", "top-1-line-0-item-0");
    }
}
