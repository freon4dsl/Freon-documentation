...
import { MinusExpression } from "../../language/gen/index.js";

import { InsuranceModelEnvironment } from "../../config/gen/InsuranceModelEnvironment.js";

/**
 * This class implements the box provider for a single node of type MinusExpression.
 ...
 */
export class MinusExpressionBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return createDefaultBinaryBox(
            ...
            "-",
            InsuranceModelEnvironment.getInstance().editor,
            this.mainHandler,
        );
    }
