...
export class Text2BoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(this._node as Text2, "Text2-overall", "", [
            ...
            BoxUtil.indentBox(this._node as Text2, 16, "3", BoxUtil.labelBox(this._node as Text2, "editor", "top-1-line-3-item-0")),
            BoxUtil.indentBox(
                this._node as Text2,
                2,
                "4",
                BoxUtil.labelBox(this._node as Text2, "for every concept of type Text.", "top-1-line-4-item-0"),
            ),
        ]);
    }
}
