...
import { InsuranceProduct, PremiumDays, InsuranceTheme } from "../../language/gen/index.js";
...
export class InsuranceProductBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default", "comments", "controls"];
    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(this._node as InsuranceProduct, "InsuranceProduct-overall", "", [
            ...
            BoxUtil.indentBox(
                ...
                8,
                "4",
                BoxUtil.verticalReferenceListBox(this._node as InsuranceProduct, "parts", InsuranceModelEnvironment.getInstance().scoper, {
                    text: ";",
                    type: "Terminator",
                }),
            ),
