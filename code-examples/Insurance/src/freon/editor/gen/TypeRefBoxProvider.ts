...
import { TypeRef, NamedType } from "../../language/gen/index.js";

import { InsuranceModelEnvironment } from "../../config/gen/InsuranceModelEnvironment.js";

/**
 * This class implements the box provider for a single node of type TypeRef.
 ...
 */
export class TypeRefBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxUtil.referenceBox(
            this._node as TypeRef,
            "type",
            (selected: string) => {
                (this._node as TypeRef).type = FreNodeReference.create<NamedType>(selected, "NamedType");
            },
