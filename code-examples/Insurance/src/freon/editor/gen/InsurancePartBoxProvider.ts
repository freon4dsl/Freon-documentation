...
export class InsurancePartBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        ...
        this.knownTableProjections = ["tableRowFor_buttonedTables", "tableRowFor_tables"];
    ...
    protected getContent(projectionName: string): Box {
        ...
        if (!this.knownBoxProjections.includes(projectionName) && !this.knownTableProjections.includes(projectionName)) {
            ...
            } else if (projectionName === "tableRowFor_buttonedTables") {
                return this.getTableRowFor_buttonedTables();
    ...
    private getTableRowFor_buttonedTables(): TableRowBox {
        const cells: Box[] = [];
