...
import { RiskAdjustmentRef } from "../../language/gen/index.js";

/**
 * This class implements the box provider for a single node of type RiskAdjustmentRef.
 ...
 */
export class RiskAdjustmentRefBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return createDefaultExpressionBox(
            this._node as RiskAdjustmentRef,
            [BoxUtil.labelBox(this._node as RiskAdjustmentRef, "riskAdjustment", "top-1-line-0-item-0")],
            { selectable: false },
        );
    }
}
