...
import { PartSyntaxAnalyserPart, ProductSyntaxAnalyserPart, InsuranceModelCommonSyntaxAnalyserPart } from "./index.js";

/**
 *   Class InsuranceModelSyntaxAnalyser is the main syntax analyser.
 ...
 *
 */
export class InsuranceModelSyntaxAnalyser implements SyntaxAnalyser {
    sourceName: string = "";
    locationMap: any;
    private _unit_Part_analyser: PartSyntaxAnalyserPart = new PartSyntaxAnalyserPart(this);
    private _unit_Product_analyser: ProductSyntaxAnalyserPart = new ProductSyntaxAnalyserPart(this);
    private _unit_common_analyser: InsuranceModelCommonSyntaxAnalyserPart = new InsuranceModelCommonSyntaxAnalyserPart(this);
