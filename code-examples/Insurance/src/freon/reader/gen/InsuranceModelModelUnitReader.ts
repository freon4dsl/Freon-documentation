...
import { InsuranceModel } from "../../language/gen/index.js";
import { InsuranceModelGrammarStr } from "./InsuranceModelGrammar.js";
import { InsuranceModelSyntaxAnalyser } from "./InsuranceModelSyntaxAnalyser.js";
import { InsuranceModelSemanticAnalyser } from "./InsuranceModelSemanticAnalyser.js";

/**
 *   Class InsuranceModelModelUnitReader is a wrapper for the various parsers of
 *   modelunits.
 */
export class InsuranceModelModelUnitReader implements FreReader {
    analyser: InsuranceModelSyntaxAnalyser = new InsuranceModelSyntaxAnalyser();
    parser: LanguageProcessor = Agl.processorFromString(InsuranceModelGrammarStr, this.analyser, null, null);
     ...
     */
    readFromString(sentence: string, metatype: string, model: InsuranceModel, sourceName?: string): FreModelUnit {
