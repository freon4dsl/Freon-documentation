...
/**
 * Class GenericKind is the implementation of the limited concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to any changes in the state of its properties.
 */
export class GenericKind extends MobxModelElementImpl implements FreNamedNode {
    /**
     * A convenience method that creates an instance of this class
     * based on the properties defined in 'data'.
     * @param data partial object
     */
    static create(data: Partial<GenericKind>): GenericKind {
    ...
    static Set: GenericKind; // implementation of instance Set
    static Sequence: GenericKind; // implementation of instance Sequence
    static Bag: GenericKind; // implementation of instance Bag
    static Collection: GenericKind; // implementation of instance Collection
    static $freANY: GenericKind; // default predefined instance

    readonly $typename: string = "GenericKind"; // holds the metatype in the form of a string
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<GenericKind>): boolean {
