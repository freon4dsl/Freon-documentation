...
import { TypeDecl, TypeUsage, GenericKind } from "./internal.js";

/**
 * Class GenericType is the implementation of the concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to the changes in the state of its properties.
 */
export class GenericType extends TypeDecl implements FreNode {
    /**
    ...
    baseType: TypeUsage; // implementation of part 'baseType'
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<GenericType>): boolean {
