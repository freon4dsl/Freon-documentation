...
import { PredefinedType, GenericKind, UnitKind } from "../../language/gen/index.js";
import { freonConfiguration } from "../../config/FreonConfiguration.js";
import { ListUtil } from "../../utils/gen/ListUtil.js";

/**
 * Class XXStdlib provides an entry point for all predefined elements in language XX.
 ...
 */
export class XXStdlib implements FreStdlib {
    ...
    public static getInstance(): FreStdlib {
        if (this.stdlib === undefined || this.stdlib === null) {
            this.stdlib = new XXStdlib();
        }
        return this.stdlib;
    }

    public elements: FreNamedNode[] = []; // the predefined elements of language XX
     ...
     */
    private constructor() {
        this.elements.push(PredefinedType.NUMBER);
        this.elements.push(PredefinedType.BOOLEAN);
        this.elements.push(PredefinedType.STRING);
        this.elements.push(PredefinedType.ANY);
        this.elements.push(PredefinedType.NULL);
        ...
        this.elements.push(UnitKind.Meters);
        this.elements.push(UnitKind.Grams);
        this.elements.push(UnitKind.kWh);
        this.elements.push(UnitKind.Hours);
