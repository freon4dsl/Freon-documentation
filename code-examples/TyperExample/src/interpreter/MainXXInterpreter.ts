...
import { XXInterpreterInit } from "./gen/XXInterpreterInit.js";
 ...
 */
export class MainXXInterpreter implements FreInterpreter {
    private static main: IMainInterpreter = null;

    constructor() {
        if (MainXXInterpreter.main === null) {
            MainXXInterpreter.main = MainInterpreter.instance(XXInterpreterInit, getConceptFunction, getPropertyFunction);
        }
    }

    setTracing(value: boolean) {
        MainXXInterpreter.main.setTracing(value);
    }

    getTrace(): InterpreterTracer {
        return MainXXInterpreter.main.getTrace();
    }
    ...
    evaluateWithContext(node: Object, ctx: InterpreterContext): RtObject {
        MainXXInterpreter.main.reset();
        try {
            return MainXXInterpreter.main.evaluate(node, ctx);
        } catch (e: any) {
