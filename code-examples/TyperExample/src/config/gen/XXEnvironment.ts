...
import { XXActions, initializeEditorDef, initializeProjections } from "../../editor/gen/index.js";
import { initializeScoperDef } from "../../scoper/gen/index.js";
import { initializeTypers } from "../../typer/gen/index.js";
import { XXValidator } from "../../validator/gen/index.js";
import { XXStdlib } from "../../stdlib/gen/XXStdlib.js";
import { XXModelUnitWriter } from "../../writer/gen/XXModelUnitWriter.js";
import { XXModelUnitReader } from "../../reader/gen/XXModelUnitReader.js";
import { MainXXInterpreter } from "../../interpreter/MainXXInterpreter.js";
import { XX, XXunit, initializeLanguage } from "../../language/gen/index.js";

/**
 * Class XXEnvironment provides the link between all parts of the language environment.
 ...
 */
export class XXEnvironment implements FreEnvironment {
    ...
    public static getInstance(): FreEnvironment {
        if (this.environment === undefined || this.environment === null) {
            this.environment = new XXEnvironment();
    ...
    validator: FreValidator = new XXValidator();
    writer: FreWriter = new XXModelUnitWriter();
    reader: FreReader = new XXModelUnitReader();
    interpreter: FreInterpreter = new MainXXInterpreter();
    projectionHandler: FreProjectionHandler;
    languageName: string = "XX";
    fileExtensions: Map<string, string> = new Map([["XXunit", "expr"]]);
}
