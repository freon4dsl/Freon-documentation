...
import {
    FlowSyntaxAnalyserPart,
    SiteGroupSyntaxAnalyserPart,
    TestSyntaxAnalyserPart,
    TopicSyntaxAnalyserPart,
    EducationCommonSyntaxAnalyserPart,
} from "./index.js";
...
export class EducationSyntaxAnalyser implements SyntaxAnalyser {
    ...
    private _unit_SiteGroup_analyser: SiteGroupSyntaxAnalyserPart = new SiteGroupSyntaxAnalyserPart(this);
    ...
    private transformSharedPackedParseTreeBranch(branch: SPPTBranch): any {
        ...
        if ("Flow" === brName) {
        ...
        } else if ("SiteGroup" === brName) {
            return this._unit_SiteGroup_analyser.transformSiteGroup(branch);
        } else if ("Test" === brName) {
        ...
        } else if ("TestFlow" === brName) {
            return this._unit_Test_analyser.transformTestFlow(branch);
        } else if ("Step" === brName) {
            return this._unit_Test_analyser.transformStep(branch);
        } else if ("LastStep" === brName) {
            return this._unit_Test_analyser.transformLastStep(branch);
        } else if ("Answer" === brName) {
            return this._unit_Test_analyser.transformAnswer(branch);
        } else if ("__fre_super_Step" === brName) {
            return this._unit_Test_analyser.transform__fre_super_Step(branch);
            ...
            return this._unit_common_analyser.transformSimpleNumber(branch);
        } else if ("Fraction" === brName) {
            return this._unit_common_analyser.transformFraction(branch);
        } else if ("NumberConcept" === brName) {
            return this._unit_common_analyser.transformNumberConcept(branch);
