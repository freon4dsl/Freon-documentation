...
import { Flow, FlowRule, PageTransition, SiteGroup, Page, Grade } from "../../language/gen/index.js";
...
export class FlowSyntaxAnalyserPart {
    ...
    public transformFlow(branch: SPPTBranch): Flow {
        ...
        // RHSPartListEntry
        if (children[5].name !== "FlowRule") {
            __rules = this.mainAnalyser.transformSharedPackedParseTreeList<FlowRule>(children[5]);
        } else {
