...
import { EducationWalker } from "../../utils/gen/index.js";
import { EducationSemanticAnalysisWalker } from "./EducationSemanticAnalysisWalker.js";
import { FreLanguageConcept, FreLanguage, FreNode, FreNodeReference } from "@freon4dsl/core";

export class EducationSemanticAnalyser {
    public correct(modelunit: FreNode) {
        ...
        let myCorrector = new EducationSemanticAnalysisWalker(changesToBeMade);
