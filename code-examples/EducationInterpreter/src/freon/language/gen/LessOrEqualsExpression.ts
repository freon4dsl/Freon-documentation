...
/**
 * Class LessOrEqualsExpression is the implementation of the binary expression concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to any changes in the state of its properties.
 */
export class LessOrEqualsExpression extends ComparisonExpression implements FreBinaryExpression {
    /**
     * A convenience method that creates an instance of this class
     * based on the properties defined in 'data'.
     * @param data partial object
     */
    static create(data: Partial<LessOrEqualsExpression>): LessOrEqualsExpression {
        const result = new LessOrEqualsExpression(data.$id);
        if (!!data.left) {
    ...
    readonly $typename: string = "LessOrEqualsExpression"; // holds the metatype in the form of a string
     ...
     */
    copy(): LessOrEqualsExpression {
        const result = new LessOrEqualsExpression();
        if (!!this.left) {
