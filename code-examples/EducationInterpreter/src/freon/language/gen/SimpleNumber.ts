...
/**
 * Class SimpleNumber is the implementation of the concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to the changes in the state of its properties.
 */
export class SimpleNumber extends NumberConcept implements FreNode {
    /**
     * A convenience method that creates an instance of this class
     * based on the properties defined in 'data'.
     * @param data partial object
     */
    static create(data: Partial<SimpleNumber>): SimpleNumber {
        const result = new SimpleNumber(data.$id);
        if (!!data.value) {
    ...
    readonly $typename: string = "SimpleNumber"; // holds the metatype in the form of a string

    parseLocation: FreParseLocation; // if relevant, the location of this element within the source from which it is parsed
    value: number; // implementation of value
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<SimpleNumber>): boolean {
