...
/**
 * Class PrimitiveType is the implementation of the limited concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to any changes in the state of its properties.
 */
export class PrimitiveType extends MobxModelElementImpl implements FreNamedNode, Type {
    /**
    ...
    static Integer: PrimitiveType; // implementation of instance Integer
    static Boolean: PrimitiveType; // implementation of instance Boolean
    static ANY: PrimitiveType; // implementation of instance ANY
    static $freANY: PrimitiveType; // default predefined instance
...
runInAction(() => {
    PrimitiveType.Integer = PrimitiveType.create({
        name: "Integer",
    });
    PrimitiveType.Boolean = PrimitiveType.create({
        name: "Boolean",
    });
    PrimitiveType.ANY = PrimitiveType.create({
        name: "ANY",
    });
});
