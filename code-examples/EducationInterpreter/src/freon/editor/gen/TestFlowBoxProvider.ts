...
import { Box, BoxUtil, FreBoxProvider, FreProjectionHandler } from "@freon4dsl/core";

import { TestFlow } from "../../language/gen/index.js";

/**
 * This class implements the box provider for a single node of type TestFlow.
 ...
 */
export class TestFlowBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "TestFlow";
    }
    ...
    private getDefault(): Box {
        return BoxUtil.horizontalPartListBox(
            this._node as TestFlow,
            (this._node as TestFlow).steps,
            "steps",
            { text: "===>", type: "Separator" },
            this.mainHandler,
        );
