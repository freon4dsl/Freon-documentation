...
import { GreaterOrEqualsExpression } from "../../language/gen/index.js";

import { EducationEnvironment } from "../../config/gen/EducationEnvironment.js";

/**
 * This class implements the box provider for a single node of type GreaterOrEqualsExpression.
 ...
 */
export class GreaterOrEqualsExpressionBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["Brackets"];
        this.knownTableProjections = ["default"];
        this.conceptName = "GreaterOrEqualsExpression";
    }
    ...
    private getDefault(): Box {
        return createDefaultBinaryBox(this._node as FreBinaryExpression, ">=", EducationEnvironment.getInstance().editor, this.mainHandler);
    }
