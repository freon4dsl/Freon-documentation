...
import { Box, BoxUtil, FreBoxProvider, FreProjectionHandler, createDefaultExpressionBox } from "@freon4dsl/core";
...
export class NrOfCorrectAnswersBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return createDefaultExpressionBox(
            ...
            [BoxUtil.labelBox(this._node as NrOfCorrectAnswers, "Number Of Correct Answers", "top-1-line-0-item-0")],
            { selectable: false },
        );
    }
}
