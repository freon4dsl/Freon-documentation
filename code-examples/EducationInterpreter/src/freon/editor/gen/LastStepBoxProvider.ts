...
import { Box, BoxUtil, FreBoxProvider, FreProjectionHandler, FreNodeReference } from "@freon4dsl/core";

import { LastStep, Page } from "../../language/gen/index.js";

import { EducationEnvironment } from "../../config/gen/EducationEnvironment.js";

/**
 * This class implements the box provider for a single node of type LastStep.
 ...
 */
export class LastStepBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "LastStep";
    }
    ...
    private getDefault(): Box {
        return BoxUtil.referenceBox(
            this._node as LastStep,
            "fromPage",
            (selected: string) => {
                (this._node as LastStep).fromPage = FreNodeReference.create<Page>(selected, "Page");
            },
