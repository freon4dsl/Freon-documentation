...
import { InDepthMaterial } from "../../language/gen/index.js";

import { PageBoxProvider } from "../../editor/gen/index.js";

/**
 * This class implements the box provider for a single node of type InDepthMaterial.
 ...
 */
export class InDepthMaterialBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "InDepthMaterial";
    }
    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(this._node as InDepthMaterial, "InDepthMaterial-overall", "", [
            BoxUtil.labelBox(this._node as InDepthMaterial, "----------------------------------------------------", "top-1-line-0-item-0"),
            BoxFactory.horizontalLayout(
                this._node as InDepthMaterial,
                "InDepthMaterial-hlist-line-1",
                "",
                [BoxUtil.labelBox(this._node as InDepthMaterial, "InDepthMaterial", "top-1-line-1-item-0"), this.getSuper("Page")],
                { selectable: false },
            ),
            BoxUtil.indentBox(
                this._node as InDepthMaterial,
                ...
                BoxUtil.verticalPartListBox(
                    this._node as InDepthMaterial,
                    (this._node as InDepthMaterial).content,
                    "content",
                    null,
                    this.mainHandler,
                ),
            ),
            BoxUtil.emptyLineBox(this._node as InDepthMaterial, "InDepthMaterial-empty-line-3"),
            BoxUtil.indentBox(
                this._node as InDepthMaterial,
                4,
                "4",
            ...
            BoxUtil.emptyLineBox(this._node as InDepthMaterial, "InDepthMaterial-empty-line-5"),
            BoxUtil.indentBox(this._node as InDepthMaterial, 4, "6", this.getSuper("Page", "footing")),
        ]);
    }
    ...
    private getSuper(superName: string, projectionName?: string): Box {
        ...
        if (!!superBoxProvider) {
            superBoxProvider.node = this._node as InDepthMaterial;
            ...
            return BoxUtil.labelBox(
                ...
                "ERROR: '" +
                    ...
                    (this._node as InDepthMaterial).freLanguageConcept() +
                    "'",
