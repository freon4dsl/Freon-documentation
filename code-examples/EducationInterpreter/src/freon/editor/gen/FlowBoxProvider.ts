...
import { Flow, SiteGroup } from "../../language/gen/index.js";
    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(this._node as Flow, "Flow-overall", "", [
            BoxFactory.horizontalLayout(
                ...
                "",
                [
                    BoxUtil.labelBox(this._node as Flow, "Flow", "top-1-line-0-item-0"),
                    BoxUtil.textBox(this._node as Flow, "name"),
                    BoxUtil.labelBox(this._node as Flow, "for SiteGroup", "top-1-line-0-item-2"),
                    BoxUtil.referenceBox(
                        this._node as Flow,
                        "main",
                        (selected: string) => {
                            (this._node as Flow).main = FreNodeReference.create<SiteGroup>(selected, "SiteGroup");
                        },
