...
import { OrExpression } from "../../language/gen/index.js";

import { EducationEnvironment } from "../../config/gen/EducationEnvironment.js";

/**
 * This class implements the box provider for a single node of type OrExpression.
...
export class OrExpressionBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return createDefaultBinaryBox(this._node as FreBinaryExpression, "or", EducationEnvironment.getInstance().editor, this.mainHandler);
    }
