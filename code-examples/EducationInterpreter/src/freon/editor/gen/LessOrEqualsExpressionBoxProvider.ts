...
import { LessOrEqualsExpression } from "../../language/gen/index.js";

import { EducationEnvironment } from "../../config/gen/EducationEnvironment.js";

/**
 * This class implements the box provider for a single node of type LessOrEqualsExpression.
 ...
 */
export class LessOrEqualsExpressionBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["Brackets"];
        this.knownTableProjections = ["default"];
        this.conceptName = "LessOrEqualsExpression";
    }
