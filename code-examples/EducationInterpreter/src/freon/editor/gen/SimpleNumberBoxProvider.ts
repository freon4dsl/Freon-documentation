...
import { Box, BoxUtil, FreBoxProvider, FreProjectionHandler, NumberDisplay } from "@freon4dsl/core";
...
export class SimpleNumberBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxUtil.numberBox(this._node as SimpleNumber, "value", NumberDisplay.SELECT);
    }
}
