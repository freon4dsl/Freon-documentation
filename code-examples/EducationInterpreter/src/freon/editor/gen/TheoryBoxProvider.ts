...
import { Theory } from "../../language/gen/index.js";

import { PageBoxProvider } from "../../editor/gen/index.js";

/**
 * This class implements the box provider for a single node of type Theory.
 ...
 */
export class TheoryBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "Theory";
    }
    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(this._node as Theory, "Theory-overall", "", [
            BoxUtil.labelBox(this._node as Theory, "----------------------------------------------------", "top-1-line-0-item-0"),
            BoxFactory.horizontalLayout(
                this._node as Theory,
                "Theory-hlist-line-1",
                "",
                [BoxUtil.labelBox(this._node as Theory, "Theory", "top-1-line-1-item-0"), this.getSuper("Page")],
                { selectable: false },
            ),
            BoxUtil.indentBox(
                this._node as Theory,
                4,
                "2",
                BoxUtil.verticalPartListBox(this._node as Theory, (this._node as Theory).content, "content", null, this.mainHandler),
            ),
            BoxUtil.emptyLineBox(this._node as Theory, "Theory-empty-line-3"),
            BoxUtil.indentBox(this._node as Theory, 4, "4", this.getSuper("Page", "footing")),
        ]);
    }
    ...
    private getSuper(superName: string, projectionName?: string): Box {
        ...
        if (!!superBoxProvider) {
            superBoxProvider.node = this._node as Theory;
            ...
            return BoxUtil.labelBox(
                ...
                "ERROR: '" +
                    ...
                    (this._node as Theory).freLanguageConcept() +
                    "'",
