        ...
        return createDefaultExpressionBox(
            ...
            [
                BoxFactory.horizontalLayout(
                    ...
                    "",
                    [
                        BoxUtil.labelBox(this._node as QuestionReference, "Answer to", "top-1-line-0-item-0"),
                        BoxUtil.referenceBox(
                            this._node as QuestionReference,
                            "question",
                            (selected: string) => {
                                (this._node as QuestionReference).question = FreNodeReference.create<Question>(selected, "Question");
                            },
                            EducationEnvironment.getInstance().scoper,
                        ),
                        BoxUtil.labelBox(this._node as QuestionReference, "is correct", "top-1-line-0-item-2"),
                    ],
                    { selectable: false },
                ),
            ],
