...
import { GradeList } from "../../language/gen/index.js";

/**
 * This class implements the box provider for a single node of type GradeList.
 ...
 */
export class GradeListBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "GradeList";
    }
    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(this._node as GradeList, "GradeList-overall", "", [
            BoxFactory.horizontalLayout(
                this._node as GradeList,
                "GradeList-hlist-line-0",
                "",
                [
                    BoxUtil.labelBox(this._node as GradeList, "GradeList", "top-1-line-0-item-0"),
                    BoxUtil.labelBox(this._node as GradeList, "{", "top-1-line-0-item-1"),
                ],
                { selectable: false },
            ),
            BoxUtil.indentBox(this._node as GradeList, 4, "1", BoxUtil.labelBox(this._node as GradeList, "list", "top-1-line-1-item-0")),
            BoxUtil.indentBox(
                this._node as GradeList,
                8,
                "2",
                BoxUtil.verticalPartListBox(this._node as GradeList, (this._node as GradeList).list, "list", null, this.mainHandler),
            ),
            BoxUtil.labelBox(this._node as GradeList, "}", "top-1-line-3-item-0"),
        ]);
    }
}
