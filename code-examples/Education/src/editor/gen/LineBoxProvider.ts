...
import { Line } from "../../language/gen/index.js";

/**
 * This class implements the box provider for a single node of type Line.
...
export class LineBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(this._node as Line, "Line-overall", "", [
            BoxFactory.horizontalLayout(
                this._node as Line,
                "Line-hlist-line-0",
                "",
                [
                    BoxUtil.labelBox(this._node as Line, "Line", "top-1-line-0-item-0"),
                    BoxUtil.labelBox(this._node as Line, "{", "top-1-line-0-item-1"),
                ],
                { selectable: false },
            ),
            BoxUtil.indentBox(
                ...
                BoxFactory.horizontalLayout(
                    ...
                    "",
                    [
                        BoxUtil.labelBox(this._node as Line, "content", "top-1-line-1-item-0"),
                        BoxUtil.textBox(this._node as Line, "content"),
                    ],
                    { selectable: false },
                ),
            ),
            BoxUtil.labelBox(this._node as Line, "}", "top-1-line-2-item-0"),
        ]);
    }
}
