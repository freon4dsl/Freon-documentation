...
import { NrOfCorrectAnswers } from "../../language/gen/index.js";

/**
 * This class implements the box provider for a single node of type NrOfCorrectAnswers.
 ...
 */
export class NrOfCorrectAnswersBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "NrOfCorrectAnswers";
    }
    ...
    private getDefault(): Box {
        return createDefaultExpressionBox(
            this._node as NrOfCorrectAnswers,
            [
                BoxFactory.verticalLayout(this._node as NrOfCorrectAnswers, "NrOfCorrectAnswers-overall", "", [
                    BoxFactory.horizontalLayout(
                        this._node as NrOfCorrectAnswers,
                        "NrOfCorrectAnswers-hlist-line-0",
                        "",
                        [
                            BoxUtil.labelBox(this._node as NrOfCorrectAnswers, "NrOfCorrectAnswers", "top-1-line-0-item-0"),
                            BoxUtil.labelBox(this._node as NrOfCorrectAnswers, "{", "top-1-line-0-item-1"),
                        ],
                        { selectable: false },
                    ),
                    BoxUtil.labelBox(this._node as NrOfCorrectAnswers, "}", "top-1-line-1-item-0"),
                ]),
            ],
            { selectable: false },
        );
