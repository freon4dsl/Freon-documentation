...
export class StepBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(this._node as Step, "Step-overall", "", [
            BoxFactory.horizontalLayout(
                this._node as Step,
                "Step-hlist-line-0",
                "",
                [
                    BoxUtil.labelBox(this._node as Step, "Step", "top-1-line-0-item-0"),
            ...
            BoxUtil.indentBox(
                ...
                BoxFactory.horizontalLayout(
                    ...
                    "",
                    [
                        BoxUtil.labelBox(this._node as Step, "fromPage", "top-1-line-1-item-0"),
            ...
            BoxUtil.indentBox(
                ...
                BoxFactory.horizontalLayout(
                    ...
                    "",
                    [
                        BoxUtil.labelBox(this._node as Step, "expectedPage", "top-1-line-2-item-0"),
                        BoxUtil.referenceBox(
                            this._node as Step,
                            "expectedPage",
                            (selected: string) => {
                                (this._node as Step).expectedPage = FreNodeReference.create<Page>(selected, "Page");
                            },
                            EducationEnvironment.getInstance().scoper,
                        ),
                    ],
            ...
            BoxUtil.labelBox(this._node as Step, "}", "top-1-line-3-item-0"),
        ]);
    }
}
