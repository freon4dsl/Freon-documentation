    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(this._node as Topic, "Topic-overall", "", [
            BoxFactory.horizontalLayout(
                ...
                "Topic-hlist-line-0",
                "",
                [BoxUtil.labelBox(this._node as Topic, "Topic:", "top-1-line-0-item-0"), BoxUtil.textBox(this._node as Topic, "name")],
                { selectable: false },
            ),
            BoxFactory.horizontalLayout(
                this._node as Topic,
                ...
                "",
                [
                    BoxUtil.labelBox(this._node as Topic, "Description:", "top-1-line-1-item-0"),
                    BoxUtil.textBox(this._node as Topic, "description"),
                ],
                { selectable: false },
            ),
            BoxUtil.emptyLineBox(this._node as Topic, "Topic-empty-line-2"),
            BoxUtil.labelBox(this._node as Topic, "Pages:", "top-1-line-3-item-0"),
