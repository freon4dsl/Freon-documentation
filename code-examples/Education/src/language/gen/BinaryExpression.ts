 ...
 */
export abstract class BinaryExpression extends ScoreExpression implements FreBinaryExpression {
    ...
    left: ScoreExpression; // implementation of part 'left'
    right: ScoreExpression; // implementation of part 'right'
