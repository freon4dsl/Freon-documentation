...
const LOGGER = new FreLogger("ExpressionsScoper");

/**
 * Class ExpressionsScoper implements the scoper generated from, if present, the scoper definition,
 * otherwise this class implements the default scoper.
 */
export class ExpressionsScoper extends FreScoperBase {
    /**
