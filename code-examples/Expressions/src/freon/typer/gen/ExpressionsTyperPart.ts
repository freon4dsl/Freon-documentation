...
/**
 * Class ExpressionsTyperPart implements the typer generated from, if present, the typer definition,
 * otherwise this class implements the default typer.
 */
export class ExpressionsTyperPart implements FreTyper {
    mainTyper: FreCompositeTyper; //  ExpressionsTyper;
    ...
    public inferType(modelelement: FreNode): FreType | null {
        ...
        if (FreLanguage.getInstance().metaConformsToType(modelelement, "DivideExpression")) {
            ...
            result = this.mainTyper.inferType((modelelement as MinusExpression) /* FretSelfExp A */?.left) /* FretPropertyCallExp C */;
            ...
            result = this.mainTyper.inferType(
                (modelelement as FunctionCallExpression) /* FretSelfExp A */?.calledFunction?.referred,
            ) /* FretPropertyCallExp C */;
        } else if (FreLanguage.getInstance().metaConformsToType(modelelement, "ParameterRef")) {
            result = this.mainTyper.inferType(
                (modelelement as ParameterRef) /* FretSelfExp A */?.parameter?.referred?.declaredType?.referred,
            ) /* FretPropertyCallExp C */;
        } else if (FreLanguage.getInstance().metaConformsToType(modelelement, "NumberLiteralExpression")) {
            result = AstType.create({ astElement: Type.Integer }) /* FretLimitedInstanceExp */;
        } else if (FreLanguage.getInstance().metaConformsToType(modelelement, "Function")) {
            result = this.mainTyper.inferType(
                (modelelement as Function) /* FretSelfExp A */?.declaredType?.referred,
            ) /* FretPropertyCallExp C */;
        } else if (FreLanguage.getInstance().metaConformsToType(modelelement, "Parameter")) {
            result = this.mainTyper.inferType(
                (modelelement as Parameter) /* FretSelfExp A */?.declaredType?.referred,
            ) /* FretPropertyCallExp C */;
        } else if (FreLanguage.getInstance().metaConformsToType(modelelement, "Type")) {
