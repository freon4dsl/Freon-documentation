...
import { Type } from "../../language/gen/index.js";
import { freonConfiguration } from "../../config/FreonConfiguration.js";
import { ListUtil } from "../../utils/gen/ListUtil.js";

/**
 * Class ExpressionsStdlib provides an entry point for all predefined elements in language Expressions.
 ...
 */
export class ExpressionsStdlib implements FreStdlib {
    ...
    public static getInstance(): FreStdlib {
        if (this.stdlib === undefined || this.stdlib === null) {
            this.stdlib = new ExpressionsStdlib();
        }
        return this.stdlib;
    }

    public elements: FreNamedNode[] = []; // the predefined elements of language Expressions
     ...
     */
    private constructor() {
        this.elements.push(Type.String);
        this.elements.push(Type.Integer);
        this.elements.push(Type.Boolean);
        this.elements.push(Type.ANY);
