 ...
 */
export abstract class BinaryExpression extends Expression implements FreBinaryExpression {
    ...
    left: Expression; // implementation of part 'left'
    right: Expression; // implementation of part 'right'
