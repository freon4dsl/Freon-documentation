...
/**
 * Class Type is the implementation of the limited concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to any changes in the state of its properties.
 */
export class Type extends MobxModelElementImpl implements FreNamedNode {
    /**
     * A convenience method that creates an instance of this class
     * based on the properties defined in 'data'.
     * @param data partial object
     */
    static create(data: Partial<Type>): Type {
        const result = new Type(data.$id);
        if (!!data.name) {
    ...
    static String: Type; // implementation of instance String
    static Integer: Type; // implementation of instance Integer
    static Boolean: Type; // implementation of instance Boolean
    static ANY: Type; // implementation of instance ANY
    static $freANY: Type; // default predefined instance

    readonly $typename: string = "Type"; // holds the metatype in the form of a string
...
runInAction(() => {
    ...
    Type.Integer = Type.create({
        name: "Integer",
    });
    Type.Boolean = Type.create({
        name: "Boolean",
    });
