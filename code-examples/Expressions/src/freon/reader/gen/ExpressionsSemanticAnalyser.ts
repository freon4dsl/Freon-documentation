...
import { ExpressionsWalker } from "../../utils/gen/index.js";
import { ExpressionsSemanticAnalysisWalker } from "./ExpressionsSemanticAnalysisWalker.js";
import { FreLanguageConcept, FreLanguage, FreNode, FreNodeReference } from "@freon4dsl/core";

export class ExpressionsSemanticAnalyser {
    public correct(modelunit: FreNode) {
        ...
        let myCorrector = new ExpressionsSemanticAnalysisWalker(changesToBeMade);
