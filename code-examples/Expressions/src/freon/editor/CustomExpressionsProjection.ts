...
/**
 * Class CustomExpressionsProjection provides an entry point for the language engineer to
 ...
 */
export class CustomExpressionsProjection implements FreProjection {
    name: string = "Custom";
