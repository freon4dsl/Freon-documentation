...
import { Parameter, Type } from "../../language/gen/index.js";
...
export class ParameterBoxProvider extends FreBoxProvider {
    ...
    private getDefault(): Box {
        return BoxFactory.horizontalLayout(
            ...
            "",
            [
                BoxUtil.labelBox(this._node as Parameter, "var", "top-1-line-0-item-0"),
                ...
                BoxUtil.limitedBox(
                    ...
                    "declaredType",
                    (selected: string) => {
                        (this._node as Parameter).declaredType = FreNodeReference.create<Type>(selected, "Type");
                    },
