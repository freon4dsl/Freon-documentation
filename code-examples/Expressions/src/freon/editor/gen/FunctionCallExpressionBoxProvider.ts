...
import { FunctionCallExpression, Function } from "../../language/gen/index.js";
                ...
                BoxFactory.horizontalLayout(
                    ...
                    [
                        BoxUtil.referenceBox(
                            ...
                            "calledFunction",
                            (selected: string) => {
                                (this._node as FunctionCallExpression).calledFunction = FreNodeReference.create<Function>(
                                    selected,
                                    "Function",
                                );
                            },
                        ...
                        BoxUtil.horizontalPartListBox(
                            this._node as FunctionCallExpression,
                            (this._node as FunctionCallExpression).arguments,
                            "arguments",
                            null,
                            this.mainHandler,
                        ),
