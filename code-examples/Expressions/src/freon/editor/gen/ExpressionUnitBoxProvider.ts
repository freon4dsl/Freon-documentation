...
import { ExpressionUnit } from "../../language/gen/index.js";

/**
 * This class implements the box provider for a single node of type ExpressionUnit.
 ...
 */
export class ExpressionUnitBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "ExpressionUnit";
    }
    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(this._node as ExpressionUnit, "ExpressionUnit-overall", "", [
            BoxUtil.labelBox(this._node as ExpressionUnit, "Functions:", "top-1-line-0-item-0"),
            BoxUtil.indentBox(
                this._node as ExpressionUnit,
                4,
                "1",
                BoxUtil.verticalPartListBox(
                    this._node as ExpressionUnit,
                    (this._node as ExpressionUnit).functions,
                    "functions",
                    null,
                    this.mainHandler,
                ),
            ),
            BoxUtil.labelBox(this._node as ExpressionUnit, "Expressions", "top-1-line-2-item-0"),
            BoxUtil.indentBox(
                this._node as ExpressionUnit,
                4,
                "3",
                BoxUtil.verticalPartListBox(
                    this._node as ExpressionUnit,
                    (this._node as ExpressionUnit).expressions,
                    "expressions",
                    null,
                    this.mainHandler,
                ),
