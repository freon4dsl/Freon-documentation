---
title: LionWeb Integration
description: How Freon integrates with the LionWeb initiative for model and language interoperability, including JSON interchange, LionWeb repository usage, and converting Freon language definitions to LionWeb format.
tags: Freon, LionWeb, interoperability, JSON, repository, server protocol, model storage, serialization, language definition, integration, documentation, beta
---
...
- To run the lionweb-repository see the GitHub page  
  <a target="_blank" href="https://github.com/LionWeb-io/lionweb-repository">https://github.com/LionWeb-io/lionweb-repository</a>.  
