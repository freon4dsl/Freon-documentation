...
Freon prevents many typing issues by enforcing the use of a typed metamodel. This ensures 
...
can introduce unintended flexibility.
...
1. Which _concepts_ or _interfaces_ are **types**?
2. Which _concepts_ or _interfaces_ **have a type**?
...
Note that it is often good practise to have a common superclass or interface for all your types,
...
<Note content={content2}> 
{#snippet content2()}
Type concept instances cannot be compared based on their identity,
...
Conformance and other rules can also be defined to apply to **any** concept. This means that
any instance of any concept conforms to the specified value.
...
<Note content={content4}>
{#snippet content4()}
<code>Anytype</code> rules must be included after the 'hasType' rules and before the inference rules. 
{/snippet}
</Note>
