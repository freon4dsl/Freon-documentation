---
title: Boolean Projections
description: Learn how to define boolean projections in Freon using textual and visual controls such as switches, checkboxes, and radio buttons, and how to override global boolean settings.
tags: boolean projections, editor controls, switch, checkbox, radio, text display, projectional editor, global projections, Freon, DSL development
---
...
Freon offers a number of different ways to display a boolean value, ranging from textual to 
...
The strings displayed for boolean values — normally `true` and `false` — can be customized.
...
string is added to the projection, its value is taken to represent `true`. The absence of the string
represents `false`.
...
- `radio`, which shows a radio group with text for the true and false values,
...
Whenever text is shown, the strings to be used as true and false values can be indicated between square brackets,
...
caption={'Examples of different boolean controls'}
figureNumber={2}
/>
