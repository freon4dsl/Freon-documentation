...
| alternative (namespace)   | A statement in the scoper definition that removes the names from the parent namespace, and replaces them by the the names of another namespace.                        |
...
| import (of a namespace)   | A statement in the scoper definition that adds the set of names from one namespace to another namespace.                                                               |
...
| declared nodes            | All nodes that have a property `name:identifier` (or _named nodes_) in the namespace subtree.                                                                          |                                                                   
| parent nodes              | All named nodes that are visible in the parent namespace of this namespace.                                                                                            |                                                                  
| imported nodes            | All declared nodes from other namespaces that have an _import relationship_ with this namespace.                                                                       |
| alternative nodes         | All declared nodes from other namespaces that have an _alternative relationship_ with this namespace.                                                                  |
| visible nodes             | All named nodes that are accessible/visible/usable within this namespace, which is build based on the declared nodes, parent nodes, imported and alternatives nodes.   |
| private property          | A property whose instances will _not_ be included in the visible nodes of a namespace when the namespace in which it is declared is imported, using namespace imports. |
