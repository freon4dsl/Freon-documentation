---
title: Introduction to the Freon Language Workbench
description: Learn what the Freon Language Workbench is, how it supports domain-specific language development, and what makes its projectional editor unique.
tags: introduction, language workbench, DSL, projectional editing, TypeScript, metamodel, validation, editor
---
...
as <a href="https://en.wikipedia.org/wiki/Domain-specific_language" target="_blank">Domain Specific Languages (DSLs)</a>.
...
easily make a projectional editor that allows for a more natural editing experience.
...
To clarify our terminology: on this site, the Freon user is called a **language engineer**. The people that will 
...
for instance via email at [info@openmodeling.nl](mailto:info@openmodeling.nl).
