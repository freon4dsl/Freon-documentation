...
implementation generated by Freon is located in the file `~/frecode/editor/gen/<yourLanguageName>ProjectionDefault.ts`.
...
file `~/frecode/editor/Custom<yourLanguageName>Projection.ts`.
...
defined in `~/frecode/editor/gen/<yourLanguageName>ProjectionDefault`.
...
You can rename the file `~/frecode/editor/Custom<yourLanguageName>Projection.ts` and/or put it in another location.
...
[customize projections](/Documentation/Defining_an_Editor#editor-three-levels).
