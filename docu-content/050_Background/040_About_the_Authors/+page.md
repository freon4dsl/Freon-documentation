...
description: Introduces Freon’s creators, Jos Warmer and Anneke Kleppe, highlighting their backgrounds in software language engineering, UML, OCL, and domain-specific languages, along with key publications.
tags: Freon, authors, Jos Warmer, Anneke Kleppe, UML, OCL, DSL, software engineering, metamodeling, modeling, publications, documentation
---
...
- **Praktisch UML, 5de editie**  
  ...
  Het is een handleiding voor het toepassen van de Unified Modeling Language (UML),  
