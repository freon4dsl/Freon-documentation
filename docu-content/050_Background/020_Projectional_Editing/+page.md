...
description: Explains the concept of projectional editing, how Freon maps the AST directly to a visual projection, and how it handles expressions, rebalancing, and persistence in projectional workflows.
tags: Freon, projectional editing, AST, expressions, tree balancing, persistence, model editing, workflow, structure editor, documentation
---
