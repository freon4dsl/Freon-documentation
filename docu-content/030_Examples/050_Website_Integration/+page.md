---
title: Integrating a Freon Editor into Your Own Web App
description: How to embed a Freon editor into a custom web application. Uses a monorepo setup (DSL + Flowbite web app), references the IntegrationExample GitHub repo, and points to relevant Freon core and core-svelte functionality.
tags: Freon, Integration, Svelte, Flowbite, core, core-svelte, monorepo, web app, editor embedding, Getting Started, documentation
---
...
<Note {header} {content}> {#snippet header()}Svelte version 5{/snippet}
{#snippet content()}
...
project in the package `dsl`, and a <a href="https://flowbite-svelte.com/" target="_blank">Flowbite</a> web app project in
