			...
			<div class="landing">
				...
				<section class="landing-enter-buttons-grid">
					...
					<a href="/Tutorial" class="landing-enter-button"
						><h3>Tutorial</h3>
						<p>
							When you are new to this tool, you may like to check out our tutorial. The tutorial takes you step-by-step through the
							creation of the environment for your own language environment. It shows how to create a language definition, an editor, how to
							add scoping and typing to your language, and how to create a validator, and an interpreter to your DSL -- from a small set of
							definitions.
						</p>
						<p>Learn more...</p>
					</a>
					...
					<a href="/Demos" class="landing-enter-button"
						...
						<p>
							There are a number of demos and videos available on this site. They cover different topics, like how to use the tool, why it
							was created, etc.
						</p>
						<p>Learn more...</p>
					</a>
					<a href="/GuidingPrinciples" class="landing-enter-button"
						...
						<p>
							<span class="landing-freon-name">Freon</span> was created using a lifetime of experience with software development, especially
							with developing softare languages. All this experience has let to a number of great guiding principles for software development,
							which are being used in the development of this tool. We happily share our insights with you.
						</p>
						<p>Learn more...</p>
					</a>
				</section>
