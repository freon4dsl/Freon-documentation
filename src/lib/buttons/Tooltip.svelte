...
<style>
  ...
  .tooltip.bottom::after {
    ...
    border-color: transparent transparent var(--theme-colors-tooltip_background)
      transparent;
  }
  .tooltip.right::after {
    content: " ";
    ...
    border-width: 5px;
    border-style: solid;
    border-color: transparent var(--theme-colors-tooltip_background) transparent
      transparent;
  }
  .tooltip.left::after {
    content: " ";
    ...
    border-color: transparent transparent transparent
      var(--theme-colors-tooltip_background);
  }
  .tooltip.top::after {
    content: " ";
    position: absolute;
