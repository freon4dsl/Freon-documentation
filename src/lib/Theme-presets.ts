...
export const themePresets = [
  {
    ...
    colors: {
      ...
      list_divider:
        PI_DARKBLUE /* Color of lines between columns in the error list */,
      ...
      secondary_button_text:
        "grey" /* Color of non-primary buttons in dialogs */,
      // TODO find some appealing default values for the user message colors
      user_mess_bg_error:
        "#ff4d4d" /* Color of user message background when showing an error */,
      user_mess_bg_warning:
        "#ffff80" /* Color of user message background when showing a warning */,
      user_mess_bg_hint:
        "#d9d9d9" /* Color of user message background when showing a hint */,
      user_mess_bg_info:
        "#d9d9d9" /* Color of user message background when showing information */,
      user_mess_text_error:
        "black" /* Color of user message text when showing an error */,
      user_mess_text_warning:
        "#ff0" /* Color of user message text when showing a warning */,
      user_mess_text_hint:
        "#ff0" /* Color of user message text when showing a hint */,
      user_mess_text_info:
        "#f50057" /* Color of user message text when showing information */,
      user_mess_button_text_error:
        "black" /* Color of user message button text when showing an error */,
      user_mess_button_text_warning:
        "#ff0" /* Color of user message button text when showing a warning */,
      user_mess_button_text_hint:
        "#ff0" /* Color of user message button text when showing a hint */,
      user_mess_button_text_info:
        "#f50057" /* Color of user message button text when showing information */,
      bg_editor: "white" /* The background color of the editor */,
      text_editor:
        "darkblue" /* The color of the text, unless set otherwise by the projection */,
      // TextBox
      bg_empty_before_text_box:
        "#f4f4f4" /* Color of background of empty textbox */,
      bg_text_box: "white" /* Color of background of non-empty textbox */,
      color_text_box: PI_DARKBLUE /* Color of text in textbox */,
      color_empty_before_text_box:
        PI_DARKBLUE /* Color of text in empty textbox */,
      // AliasBox
      bg_empty_before_alias_box:
        "#f4f4f4" /* Color of background of empty alias */,
  ...
  },
  {
    ...
    colors: {
      ...
      text_editor:
        "white" /* The color of the text, unless set otherwise by the projection */,
      // TextBox
