...
export const documentationToc: TocContentsType = {
	...
	content: [
		...
		{
			name: 'Defining Scope Rules',
			path: '/Documentation/Defining_Scope_Rules',
			content: [
		...
		{
			name: 'Typing and Validating',
			path: '/Documentation/Typing_and_Validating',
			content: [
				{ name: 'Type Provider', path: '/Documentation/Typing_and_Validating/Type_Provider' },
				{ name: 'Validator', path: '/Documentation/Typing_and_Validating/Validator' }
			]
		},
		{
			name: 'Interpreter Framework',
			path: '/Documentation/Interpreter_Framework',
			content: [
		...
		{ name: 'CommandLine', path: '/Documentation/CommandLine' },
		{
			name: 'Under the Hood',
...
export const examplesToc: TocContentsType = {
	...
	content: [
		{ name: 'Overview', path: '/Examples/Overview' },
		{
			...
			path: '/Examples/Building_an_Interpreter',
			content: [
		...
		},
		{
			...
			path: '/Examples/External_Components',
			content: [
		...
		},
		{
			...
			path: '/Examples/Website_Integration',
			content: [
				{ name: 'Getting Language Information', path: '/Examples/Website_Integration/Getting_Language_Information' },
				{ name: 'Including Model Information', path: '/Examples/Website_Integration/Including_Model_Information' },
				{ name: 'Adding the Editor', path: '/Examples/Website_Integration/Adding_the_Editor' }
			]
		}
	]
};
