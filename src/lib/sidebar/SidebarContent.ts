...
export const documentationToc: TocContentsType = {
	...
	content: [
		...
		},
		{
			...
			path: '/Documentation/Developing_a_Language',
			content: [
				{ name: 'Default Level', path: '/Documentation/Developing_a_Language/Default_Level' },
				{
					name: 'Defining the Language Structure',
					path: '/Documentation/Developing_a_Language/Default_Level/Defining_the_Language_Structure'
				},
				...
				{ name: 'Fragments', path: '/Documentation/Developing_a_Language/Definition_Level/Editor_Definition/Fragments' },
				{
					...
					path: '/Documentation/Developing_a_Language/Definition_Level/Editor_Definition/External_Components'
				},
				...
				{ name: 'Example Structure', path: '/Documentation/Developing_a_Language/Definition_Level/Typer_Definition/Example_Structure' },
				{
					...
					path: '/Documentation/Developing_a_Language/Definition_Level/Typer_Definition/Example_Typer_Definition'
				},
		...
		},
		{
			...
			content: [
				...
				{ name: 'The Editor Interfaces', path: '/Documentation/Under_the_Hood/The_Editor_Framework/The_Editor_Interfaces' },
				{
					...
					path: '/Documentation/Under_the_Hood/The_Editor_Framework/The_Editor_Interfaces/FreProjection_Interface'
				},
				{
					name: 'FreAction Interface',
					path: '/Documentation/Under_the_Hood/The_Editor_Framework/The_Editor_Interfaces/FreAction_Interface'
				},
				{
					name: 'FreExpression Interface',
					path: '/Documentation/Under_the_Hood/The_Editor_Framework/The_Editor_Interfaces/FreExpression_Interface'
				},
				{
					name: 'FreBinary Expression Interface',
					path: '/Documentation/Under_the_Hood/The_Editor_Framework/The_Editor_Interfaces/FreBinary_Expression_Interface'
				},
				{
					name: 'FreElement Interface',
					path: '/Documentation/Under_the_Hood/The_Editor_Framework/The_Editor_Interfaces/FreElement_Interface'
				},
				{
					name: 'FreNamedElement Interface',
					path: '/Documentation/Under_the_Hood/The_Editor_Framework/The_Editor_Interfaces/FreNamedElement_Interface'
				},
...
export const tutorialToc: TocContentsType = { name: 'Tutorial', path: '/Tutorial', content: [{ name: 'Intro', path: '/Tutorial/Intro' }] };
export const examplesToc: TocContentsType = { name: 'Examples', path: '/Examples', content: [{ name: 'Intro', path: '/Examples/Intro' }] };
export const demosToc: TocContentsType = { name: 'Demos', path: '/Demos', content: [{ name: 'Intro', path: '/Demos/Intro' }] };
