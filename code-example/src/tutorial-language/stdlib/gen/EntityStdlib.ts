 ...
 */
export class EntityStdlib implements FreStdlib {
    ...
    public elements: FreNamedNode[] = []; // the predefined elements of language Entity
     ...
     * @param metatype
     */
    public find(name: string, metatype?: EntityMetaType): FreNamedNode {
        if (!!name) {
