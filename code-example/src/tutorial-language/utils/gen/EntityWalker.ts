...
const LOGGER = new FreLogger("EntityWalker");
...
export class EntityWalker {
    ...
    private walkText4(modelelement: Text4, includeChildren?: (elem: EntityEveryConcept) => boolean) {
        let stopWalkingThisNode: boolean = false;
        for (const worker of this.myWorkers) {
            if (!stopWalkingThisNode) {
    ...
    private walkText3(modelelement: Text3, includeChildren?: (elem: EntityEveryConcept) => boolean) {
        let stopWalkingThisNode: boolean = false;
        for (const worker of this.myWorkers) {
            if (!stopWalkingThisNode) {
    ...
    private walkText2(modelelement: Text2, includeChildren?: (elem: EntityEveryConcept) => boolean) {
        let stopWalkingThisNode: boolean = false;
        for (const worker of this.myWorkers) {
            if (!stopWalkingThisNode) {
